...
# Increase spacing between lines to prevent overlapping of diacritics
css = re.sub(
    r'margin-bottom:\s*calc\(-0\.5em\s*\+\s*2px\);',
    r'margin-bottom: calc(-0.5em + 12px);',
    css
)
...
print("Increased line spacing by 10px and bumped version")
